...
public class Account {
	...
	public void sendNotification() {
		...
		if (covidState.equals("positive")) {
			message =date.format(formatter) + " " + DateTimeFormatter.ofPattern("hh:mm a").format(LocalTime.now())+ "Your friend " + surname + " " + name + " has been tested possitive for COVID-19"
					 ;
		} else if (covidState.equals("negative")) {
			message = date.format(formatter) + " " + DateTimeFormatter.ofPattern("hh:mm a").format(LocalTime.now())+"Your friend " + surname + " " + name + " has been tested negative for COVID-19 "
					 ;
		} else if (covidState.equals("recovered")) {
			message =date.format(formatter) + " " + DateTimeFormatter.ofPattern("hh:mm a").format(LocalTime.now())+ "Your friend " + surname + " " + name + " has recovered from COVID-19 "
					 ;
		}
		if (friends.size() != 0) {
			...
			if (covidState.equals("positive")) {
				...
				for (int i = 0; i < friends.size(); i++) {
					message =date.format(formatter) + " "
							+ DateTimeFormatter.ofPattern("hh:mm a").format(LocalTime.now())+ "One person from " + data.getSurname(friends.get(i)) + " " + data.getName(friends.get(i))

...
public class SignUpwithgraphics extends JFrame {
	...
	public SignUpwithgraphics() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] { "Acharnes", "Aegina", "Agia Paraskevi",
				...
				"Markopoulo Mesogaias", "Marousi", "Megara", "Metamorfosi", "Moschato-Tavros", "Nea Ionia",
				"Nea Smyrni", "Nikaia-Agios Ioannis Rentis", "Oropos", "Paiania", "Palaio Faliro", "Pallini",
				"Papagou-Cholargos", "Penteli", "Perama", "Peristeri", "Petroupoli", "Piraeus", "Rafina-Pikermi",
				"Salamis ", "Saronikos", "Spata-Artemida", "Spetses", "Troizinia-Methana", "Vari-Voula-Vouliagmeni",
				"Vrilissia", "Vyronas", "Zografou" }));
		...
		year.setModel(new DefaultComboBoxModel(new String[] { "2019", "2018", "2017", "2016", "2015", "2014", "2013",
